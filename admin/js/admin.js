...
class AdminDashboard {
    ...
    async handleLogin(e) {
        ...
        // Debug logs
        console.log('Tentativa de login:', { username: username, passwordLength: password.length });
        ...
        if (isValidLogin) {
            ...
            console.log('Login falhou:', { username, passwordLength: password.length });
            ...
            // Limpar campos e erro após 3 segundos
            setTimeout(() => {
                if (errorDiv) {
                    errorDiv.style.display = 'none';
                }
